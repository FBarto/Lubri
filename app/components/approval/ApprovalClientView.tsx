        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
                <button
                    ...
                    disabled={processing}
                    className="py-4 rounded-2xl font-bold bg-white text-red-600 border-2 border-slate-100 hover:bg-red-50 hover:border-red-200 transition-all active:scale-95 disabled:opacity-50"
                >
                    Rechazar
                </button>
                <button
                    ...
                    disabled={processing}
                    className="py-4 rounded-2xl font-bold bg-emerald-500 text-white hover:bg-emerald-600 shadow-lg shadow-emerald-200 transition-all active:scale-95 disabled:opacity-50"
                >
