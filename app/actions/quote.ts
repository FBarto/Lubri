...
export async function saveQuote(caseId: string, data: QuoteUpdateData): Promise<ActionResponse> {
    try {
...
export async function updateQuoteStatus(quoteId: string, status: QuoteStatus): Promise<ActionResponse> {
    try {
