        ...
        try {
            ...
            if (res.ok) {
                ...
                if (isMassLoad) {
                    ...
                    // If not mass load, we still show the banner success instead of immediate redirect
                    // This gives the user the chance to send WhatsApp or go to detail
    ...
    const handleSendWhatsApp = async () => {
        ...
        try {
            ...
            if (resLink.success && resLink.data?.url) {
                ...
                const message = `¡Hola ${lastSavedOrder.clientName}! 👋 Te paso la Libreta Digital de tu ${carName} para que lleves el control de tus services en FB Lubricentro 🛠️.\n\nAcá tenés el link: ${fullLink}\n\nGuardalo para tu próximo service. ¡Te esperamos! 🚗`;
                        ...
                        <div className="p-8 text-center">
                            ...
                            <div className="space-y-3">
                                ...
                                >
                                    ...
                                    {sendingWhatsApp ? 'Preparando...' : 'WhatsApp al Cliente'}
                                </button>
                                ...
                                <button
                                    ...
                                    className="w-full bg-slate-100 text-slate-500 p-5 rounded-2xl font-black hover:bg-slate-200 transition-all active:scale-95 uppercase tracking-widest text-xs"
                                >
                                    {isMassLoad ? 'Próximo Paper 📄' : 'Volver al Inicio 🏠'}
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white w-full max-w-lg rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 border border-slate-200">
                        <div className="p-8">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-xl font-black text-slate-900 uppercase italic">Revisar Mensaje 📝</h2>
                                <button
                                    onClick={() => setWhatsappPreviewModal(false)}
