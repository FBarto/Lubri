                ...
                <div className="bg-emerald-50 border border-emerald-200 p-6 rounded-3xl mb-8 flex flex-col md:flex-row items-center justify-between gap-4 animate-in fade-in zoom-in duration-300">
                    <div>
                        ...
                        <a
                            ...
                            className="text-xs font-bold text-emerald-700 underline hover:text-emerald-900 mt-1 inline-block"
                        >
                            Ver detalle de la orden # {lastSavedOrder.id}
                        </a>
                    </div>
                    <div className="flex flex-wrap gap-2 justify-center">
                        <button
                            ...
                            className="bg-emerald-600 text-white px-6 py-3 rounded-2xl font-bold flex items-center gap-2 hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-500/20 text-sm"
                        ...
                        <button
                            ...
                            className="bg-white text-slate-500 px-6 py-3 rounded-2xl font-bold border border-slate-200 hover:bg-slate-50 transition-all text-sm"
                        >
                            {isMassLoad ? 'Siguiente Paper 📄' : 'Ir al Tablero 🏠'}
                        </button>
                    </div>
                </div>
            )}
